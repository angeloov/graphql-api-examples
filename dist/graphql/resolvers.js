...
var join_monster_1 = __importDefault(require("join-monster"));
var db_1 = __importDefault(require("../lib/db"));
exports.default = {
    Query: {
        books: function (parent, args, ctx, resolveInfo) {
            var _this = this;
            return join_monster_1.default(resolveInfo, ctx, function (sql) { return __awaiter(_this, void 0, void 0, function () {
                var res;
